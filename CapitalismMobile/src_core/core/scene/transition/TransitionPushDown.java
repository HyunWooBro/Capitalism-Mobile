...
public class TransitionPushDown extends Transition {
	
	public TransitionPushDown(long duration) {
		this(0, duration, null, null);
	}
	
	public TransitionPushDown(long duration, Interpolator interpolator) {
		this(0, duration, interpolator, null);
	}
	
	public TransitionPushDown(long startOffset, long duration) {
		this(startOffset, duration, null, null);
	}
	
	public TransitionPushDown(long startOffset, long duration, Interpolator interpolator) {
		this(startOffset, duration, interpolator, null);
	}

	public TransitionPushDown(long duration, Scene<?> scene) {
		this(0, duration, null, scene);
	}
	
	public TransitionPushDown(long duration, Interpolator interpolator, Scene<?> scene) {
		this(0, duration, interpolator, scene);
	}
	
	public TransitionPushDown(long startOffset, long duration, Scene<?> scene) {
