...
/**
 * Widget은 {@link Layout}을 구현하는 {@link Actor}이다. 즉, Widget은 자신을 Stage내에서 
 * 어떻게 배치할 것인지를 결정할 수 있는 Actor이다. Widget을 확장하는 하위 클래스에서는 
 * {@link #layout()}을 재정의하여 자신을 어떻게 배치할 지를 구현해야 한다.
 * 
 * @author 김현우
 */
@SuppressWarnings("unchecked")
public abstract class Widget<T extends Widget<T>> extends Actor<T> implements Layout<T> {
